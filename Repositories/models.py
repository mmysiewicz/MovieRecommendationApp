from sqlalchemy import Column, String, Integer, ForeignKey, Table, null
...
class Movie(Base):
    ...
    Rate = relationship("Rate", back_populates="Movie")

    @property
    def poster_path(self):
        if self.Title:
            return f"Assets/Posters/{self.Title}.jpg"
        return None
...
class Person(Base):
    ...
    MoviePersons = relationship("MoviePerson", back_populates="Person")
